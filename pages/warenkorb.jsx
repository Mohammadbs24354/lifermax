...
export default function Warenkorb() {
  ...
  const clientID = "AcVWlDGv1pFOZdpbFo8c8TjjhKHlD-it9_MoXcNlNEFHAKvCVOH8Ur9w0fglB3MsEwEY_lRfc55O36MF";
                  ...
                  const kunde = details.purchase_units[0].shipping;
                    erstelleBestellung({
                      ...
                      produkte: warenkorb.produkte.map((produkt) => (
                        {
                          name: produkt.name, menge: produkt.menge, extras: produkt.extras.map(extra => (extra.text))
                        }
                      )),
                    });
                  });
            ...
            <div className="col-3 p-2">
              <div className='shadow'>
                <Card>
                  ...
                  <Card.Body className='text-center'>Gesamt
                    <Card.Title>
                      {warenkorb.gesamtbetrag.toFixed(2)} EUR
                    </Card.Title>
                    {kasse ? (
                      <PayPalScriptProvider options={{ clientId: clientID, components: "buttons", currency: "EUR" }}>
